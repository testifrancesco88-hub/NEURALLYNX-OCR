      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 md:py-20">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-6xl md:text-8xl font-black text-slate-900 tracking-tighter mb-8 uppercase italic">
            Visual{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-br from-blue-600 via-cyan-500 to-blue-400 drop-shadow-sm">
              Decoding
            </span>
          </h1>
          ...
          {!isCameraActive ? (
            <div
              className={`relative group bg-white border-2 border-dashed rounded-[3rem] p-10 md:p-16 transition-all duration-700 ${
                isDragging
                  ? "border-blue-500 bg-blue-50/20 scale-[1.03] shadow-[0_0_40px_rgba(37,99,235,0.15)]"
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                <div
                  className={`mb-8 p-6 rounded-[2rem] transition-all duration-1000 relative group-hover:scale-110 ${
                    isDragging
                      ? "bg-blue-600 text-white shadow-blue-400 shadow-[0_0_30px_rgba(37,99,235,0.5)] rotate-[360deg]"
            ...
            <div className="relative bg-black rounded-[3rem] overflow-hidden shadow-2xl aspect-video md:aspect-[21/9] flex flex-col items-center justify-center border-4 border-blue-600">
              ...
              <div className="absolute inset-0 pointer-events-none border-[40px] border-black/20">
                ...
                <div className="absolute top-10 left-10 text-[10px] text-cyan-400 font-black tracking-widest uppercase">
                  Stream: Active
                </div>
                <div className="absolute bottom-10 right-10 text-[10px] text-cyan-400 font-black tracking-widest uppercase">
                  Neural_Sync: On
                </div>
              </div>
        ...
        {results.length > 0 && (
          <div className="mt-24">
            <div className="flex justify-between items-end mb-12 border-b-2 border-slate-100 pb-8">
              <div>
                <h2 className="text-5xl font-black text-slate-900 tracking-tighter uppercase italic">
                  Synthesis <span className="text-blue-600">Feed</span>
                </h2>
            ...
            <div className="grid gap-12">
              {results.map((result) => (
                <ResultCard key={result.id} result={result} onRemove={removeResult} />
              ))}
            </div>
          </div>
        )}
